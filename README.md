...
python -m speak2me.app                 # the window, with voice and avatar
python -m speak2me.app --terminal      # response layer only, no audio, no window
```
...
pytest          # 84 tests, no network, no window
ruff check .
```
